...
//import com.cwc.litenote.Constants.Extra;
...
import com.nostra13.universalimageloader.core.display.FadeInBitmapDisplayer;
	...
	public class PicturePagerAct extends Activity {
...
//	}
	...
	private class ImagePagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup view, int position) {
			View imageLayout = inflater.inflate(R.layout.picture_pager_item, view, false);
			...
			imageLoader.displayImage(images[position], imageView, options, new SimpleImageLoadingListener() {
				...
				public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
					...
					Toast.makeText(PicturePagerAct.this, message, Toast.LENGTH_SHORT).show();
